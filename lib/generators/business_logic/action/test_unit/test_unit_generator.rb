      ...
      class TestUnitGenerator < Rails::Generators::NamedBase
        ...
        def generate_files
          ...
          if options[:component]
            ...
            # i.e. template "action.rb.erb.tt", "test/components/identity/actions/#{file_name}_action.rb"
            template "action_test.rb.erb.tt", "#{root_file_path}/actions/#{file_name}_action.rb"
          else
